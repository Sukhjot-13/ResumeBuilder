...
const PERMISSION_METADATA = {
  ...
  manage_users:            { name: "Manage Users", description: "Ban, delete user accounts.", requiredPlan: "ADMIN" },
  change_user_role:        { name: "Change User Role", description: "Promote or demote user roles.", requiredPlan: "ADMIN" },
  ...
  manage_credits:          { name: "Manage Credits", description: "Manually add or reset user credits.", requiredPlan: "ADMIN" },
  unlimited_credits:       { name: "Unlimited Credits", description: "Bypass all credit limits.", requiredPlan: "ADMIN" },
